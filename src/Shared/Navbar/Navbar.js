        ...
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={1} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-sky-500 rounded-box w-52">
                        {menuItem}
                    </ul>
                </div>
                <Link to='/' className="btn btn-ghost normal-case text-xl text-primary font-bold">Resale Product</Link>
            </div>
